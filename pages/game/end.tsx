...
const Round: NextPage = () => {
  const { players, setPlayers, setLeftRounds } = useStore(
    ({ players, setPlayers, setLeftRounds }) => ({
      players,
      setPlayers,
      setLeftRounds,
    })
          ...
          <div className={styles.player}>
            <div className={styles.place}>
              {i == 0 ? (
                ...
                <Image src={silvelMedal} alt={"Médaille d'argent"} />
              ) : i == 2 ? (
                <Image src={bronzeMedal} alt={"Médaille de bronze"} />
              ) : (
                i + 1
              )}
            </div>
